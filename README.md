# Mastodon RSS United States stack module

Content-only Platform Zero module providing curated independent United States news feeds and Mastodon bootstrap follows to `mastodon-rss-publisher`.
